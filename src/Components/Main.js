...
import Heart from "./page/Heart.png"
    ...
    return(
        ...
        <Spotlight>
          ...
          <Moviesbox>
            ...
            <Icon onClick={this.handleClick} style={this.state.listMovies === false ?{filter:"brightness(0.5)"}: {filter:"drop-shadow(1px 1px 10px rgba(255,255,255,0.5))"}} src={Heart} alt="heart icon"/>
